...
import style from "./FormAsesor.module.css";
import { useState } from "react";
import { validarFormulario } from "../../../helpers/logicErrorForm";
import "boxicons";
const FormAsesor = (props) => {
    ...
    <div className={style.form_container}>
      <div className={toggle ? style.cortain : style.noCortain}>
        <section>
          <div className={style.imageCortain}>
            <img src="https://res.cloudinary.com/dce6wpls5/image/upload/v1708902271/c804e300-8455-4b7d-b3e0-972e50aeaaeb_gdk8cn.png" alt="latinPay" />
          </div>
          <h1>Gracias, {data.name}</h1>
          <span>
            <p>En unos minutos nuestro asesor se comunicará contigo.</p>
            <p>Presiona el siguiente botón para seguir con tu compra</p>
          </span>
          <a>
            <button onClick={props.hideUp}>Vamos allá</button>
          </a>
        </section>
      </div>
      <div className={style.left_container}>
        ...
        <div className={style.texto}>
          <p>
            Para seguir con la confirmación de la compra <b>a</b>
            <b onClick={props.hideUp} className={style.aqui}>
               quí
            </b>
          </p>
        </div>
      ...
      <div className={style.rigth_container}>
        <h3>Para solicitar un asesor ingrese sus datos</h3>
